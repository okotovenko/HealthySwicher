...
class ScrollWatcher {
	...
	scrollWatcherCallback(entry, observer) {
		...
		if (targetElement.dataset.watch === 'titleAnim' && targetElement.classList.contains('_watcher-view')) {
		...
		if (targetElement.dataset.watch === 'textAnim' && targetElement.classList.contains('_watcher-view')) {
